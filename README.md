...
* `Глаз'ОК` - метод создания раскладки, когда не используются никакие сложные математические вычисления, а клавиши просто расставляются на глазок. Активно используется большинством раскладкоделов в нашем чате.
